...
import { MNewAreaTemplateComponent } from './m-new-area-template/m-new-area-template.component';
import { MEditAreaTemplateComponent } from './m-edit-area-template/m-edit-area-template.component';
